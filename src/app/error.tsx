...
export default function ErrorBoundary({
  ...
  return (
    <main className="bg-brand-cream flex min-h-screen flex-col items-center justify-center px-5 py-24 text-center font-sans md:px-8">
