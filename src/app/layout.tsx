...
export const metadata: Metadata = {
  ...
  description: `Audit, taxation, ERP, corporate advisory, bookkeeping, accounting outsourcing, and risk advisory for businesses in the UAE, UK, and USA. A specialized partner of ${parentFirmName}.`,
  openGraph: {
